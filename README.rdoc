...
The gem defines the class TNEF with just one class method to convert a given winmail.dat file. Use it with a block like in the following example:
...
This code is based on the work by Peter Collingbourne, published as part of the project whatdotheyknow[http://github.com/mysociety/whatdotheyknow/blob/master/lib/tnef.rb]
